...
class OutdatedTaskListItemCallback(
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        when (viewHolder) {
            is OutdatedUncompletedTaskAdapter.OutdatedTaskViewHolder -> {
    ...
    override fun getSwipeDirs(
        ...
        return if (viewHolder.itemViewType == R.layout.item_outdated_completed_task_header) {
            ItemTouchHelper.ACTION_STATE_IDLE
        } else {
