...
class TrashedTaskListItemCallback(
    val onUncompletedItemDelete: (Int) -> Unit,
    val onCompletedItemDelete: (Int) -> Unit,
    val onUncompletedItemRestore: (Int) -> Unit,
    val onCompletedItemRestore: (Int) -> Unit
